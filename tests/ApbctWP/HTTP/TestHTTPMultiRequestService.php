...
class TestHTTPMultiRequestService extends TestCase
{
    private $testFolder;
    ...
    {
        $fabric = $this->getMockBuilder(HTTPMultiRequestService::class)
    ...
    {
        $fabric = new HTTPMultiRequestService();
    ...
    public function testSetMultiContractReturnsItself()
    {
        ...
        $this->assertInstanceOf(HTTPMultiRequestService::class, $result);
