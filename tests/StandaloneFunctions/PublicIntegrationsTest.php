...
<input type="submit" id="searchsubmit" value="Search" />
        ...
        $success = (preg_match('/class=".*?apbct__email_id__search_form/', apbct_form_search__add_fields($sample_form)) ||
                   preg_match('/id=".*?apbct_event_id/', apbct_form_search__add_fields($sample_form))
                    )&&
