...
function ct_get_admin_email()
{
    ...
    if (is_main_site() || $apbct->network_settings['multisite__work_mode'] == 1 || $apbct->network_settings['multisite__work_mode'] == 2) {
        return $apbct->data['account_email'] ?: get_site_option('admin_email');
    }
    
    // Individual account
    return get_network_option( get_current_blog_id(), 'admin_email' );
}
