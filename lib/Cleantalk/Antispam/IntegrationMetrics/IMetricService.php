    ...
    class IMetricService
    {
        ...
        public static function getDTO($integration)
        {
            ...
            if ($dto_version) {
                ...
                $dto->integration_name = substr($full_class, strrpos($full_class, '\\') + 1);
         ...
         * @param string $span
         */
        public static function dumpVarsSize($integration, array $vars = [], string $span = 'undefined_variable_span'): void {
            $dto = $integration->getImetricDTO();
            if (!$dto || empty($vars)) {
                return;
            }
