...
class ContactsEncoder extends \Cleantalk\Common\ContactsEncoder\ContactsEncoder
{
    ...
    private $is_buffer_enabled = false;

    public function __construct($params = array())
    {
        // check if in skip_rules array any value is true
        if (isset($params['skip_rules']) && is_array($params['skip_rules']) &&
            array_filter($params['skip_rules'], function($value) {
                return $value == true;
            })
        ) {
            return;
        ...
        if (isset($params['is_buffer_enabled']) && is_bool($params['is_buffer_enabled'])) {
            $this->is_buffer_enabled = $params['is_buffer_enabled'];
        }
    }
