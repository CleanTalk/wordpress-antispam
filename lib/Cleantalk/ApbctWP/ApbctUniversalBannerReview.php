        ...
        <div class="apbct-notice notice apbct-banner-success is-dismissible" id="<?php echo esc_attr($banner_id); ?>">
            <div class="apbct-banner-content" style="display: block;margin-bottom: 16px;">
                <div style="display: flex;">
                    <img src="<?php echo esc_url($logo_url); ?>" width="111px" height="24" alt="CleanTalk Logo">
                ...
                <div class="apbct-banner-text-wrapper" style="display: flex;flex-wrap: wrap;justify-content: space-between;">
                    <div style="display: flex; gap: 32px;">
                        <img src="<?php echo esc_url($review_img_url); ?>" width="92px" height="81px" alt="CleanTalk Review Logo" style="align-self: center;">
                        <div>
                    ...
                    <div class="apbct-banner-button-wrapper">
                        <a href="<?php echo esc_url($data->button_url); ?>" target="_blank" class="apbct-banner-button apbct-banner-button-green"><?php echo esc_html($data->button_text); ?></a>
