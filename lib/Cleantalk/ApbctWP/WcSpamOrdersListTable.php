    ...
    public function prepare_items()  // phpcs:ignore PSR1.Methods.CamelCapsMethodName.NotCamelCaps
    {
        ...
        foreach ( $wc_spam_orders_to_show as $wc_spam_order ) {
            ...
            $actions = array(
                ...
                'details' => '<a class="apbct-details-spam-order-button" role="button" tabindex="0" data-spam-order-id="' . $wc_spam_order->id . '">' . esc_html__('See details', 'cleantalk-spam-protect') . '</a>',
                /*'approve' => sprintf(
