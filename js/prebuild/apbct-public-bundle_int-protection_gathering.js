 ...
 * @param {string} url
 */
<<<<<<< HEAD:js/prebuild/apbct-public-bundle_int-protection_gathering.js
...
if (ctPublic.data__key_is_ok) {
    if (document.readyState !== 'loading') {
        apbct_ready();
>>>>>>> tag-59:js/src/apbct-public-bundle_int-protection_comm-func.js
    } else {
        log.err = {
            'msg': msg,
        };
...
>>>>>>> tag-6.58:js/src/apbct-public-bundle_int-protection_comm-func.js
document.addEventListener('DOMContentLoaded', function() {
